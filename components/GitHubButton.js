...
const GitHubButton = () => {
  ...
  return (
    <div style={{ marginTop: "4px", marginRight: "10px", marginLeft: "5px" }}>
      <button
        type="button"
        ...
        style={{
          color: themeStyles.theme === Theme_Name.DARK_MODE ? "white" : "black",
        }}
      >
        <a href="https://github.com/visheshgarg797/Codemirror-Ide">
          <svg
