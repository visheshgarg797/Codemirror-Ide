  ...
  return (
    ...
    >
      <nav className="flex flex-col items-stretch" style={{ width: "20rem" }}>
        ...
        <ButtonLeft index="Introduction" href="http://localhost:3000/intro" />
        <ButtonLeft index="Analysis" href="http://localhost:3000/analysis" />
        <ButtonLeft index="Editor" href="http://localhost:3000/editor" />
        <ButtonLeft
          index="Conclusion"
